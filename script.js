...
function getMyLocation(){
    if(!navigator.geolocation){
        alert("incompatible browser for this website");
    }

    // runs when location access is allowed
    else{ 
        // alert("access allowed");
        navigator.geolocation.getCurrentPosition(myCoOrdinates);
    }
}

//runs when coodinates get fetched correctly
function myCoOrdinates(myCurrPosition){
